...
def get_settings() -> AppSettings:
    ...
    return AppSettings(
        ...
        rag_embedding_provider=get_env_value("RAG_EMBEDDING_PROVIDER", "sentence-transformers"),
        rag_embedding_model=get_env_value("RAG_EMBEDDING_MODEL", "sentence-transformers/all-MiniLM-L6-v2"),
